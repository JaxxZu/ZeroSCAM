...
object ServerConfig {
    val PRESETS = listOf(
        "https://detect-jetson:5000/" to "ZeroSCAM server1",
        "https://detect.443.gs/" to "ZeroSCAM server2",
        "https://detect2.443.gs/" to "ZeroSCAM server3"
    )
...
object ServerConfigAdvice {
  ...
  "messages": [
    ...
    val PROVIDERS = listOf(
        ...
        AdviceProvider(
            name = "server2 (Qwen)",
            baseUrl = "https://llm-guo.443.gs/v1/",
            apiKey = "7a4c019c-db87-4e21-b90e-9cfc75057f7e",
            modelId = "qwen/qwen3-30b-a3b-2507",
            useAuthHeader = false,
            supportsReasoning = false,
